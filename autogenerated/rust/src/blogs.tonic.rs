...
pub mod blogs_client {
    ...
    impl BlogsClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> BlogsClient<InterceptedService<T, F>>
        where
...
pub mod blogs_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with BlogsServer.
    #[async_trait]
    pub trait Blogs: Send + Sync + 'static {
        async fn list_blogs(
            &self,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for BlogsServer<T>
    where
        T: Blogs,
        B: Body + Send + 'static,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/blogs.Blogs/ListPublishedBlogs" => {
                    ...
                    for ListPublishedBlogsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Blogs>::list_published_blogs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListPublishedBlogsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/blogs.Blogs/PublishBlog" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PublishBlogSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: Blogs> Clone for BlogsServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Blogs> tonic::server::NamedService for BlogsServer<T> {
        const NAME: &'static str = "blogs.Blogs";
    }
}
/// Generated client implementations.
pub mod tags_client {
    ...
    impl TagsClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
...
pub mod tags_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with TagsServer.
    #[async_trait]
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for TagsServer<T>
    where
        T: Tags,
        B: Body + Send + 'static,
        B::Error: Into<StdError> + Send + 'static,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/blogs.Tags/SetBlogTags" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetBlogTagsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T: Tags> Clone for TagsServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: Tags> tonic::server::NamedService for TagsServer<T> {
        const NAME: &'static str = "blogs.Tags";
    }
}
