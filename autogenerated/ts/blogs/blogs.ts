...
export const ListBlogsPaginationToken: MessageFns<ListBlogsPaginationToken> = {
  ...
  fromJSON(object: any): ListBlogsPaginationToken {
    return {
      lastCreatedAt: isSet(object.lastCreatedAt)
        ? fromJsonTimestamp(object.lastCreatedAt)
        : isSet(object.last_created_at)
        ? fromJsonTimestamp(object.last_created_at)
        : undefined,
    };
  },
...
export const SetBlogTagsRequest: MessageFns<SetBlogTagsRequest> = {
  ...
  fromJSON(object: any): SetBlogTagsRequest {
    return {
      blogId: isSet(object.blogId)
        ? globalThis.String(object.blogId)
        : isSet(object.blog_id)
        ? globalThis.String(object.blog_id)
        : "",
      tagNames: globalThis.Array.isArray(object?.tagNames)
        ? object.tagNames.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.tag_names)
        ? object.tag_names.map((e: any) => globalThis.String(e))
        : [],
    };
  },
