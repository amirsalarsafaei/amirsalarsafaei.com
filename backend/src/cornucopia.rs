...
pub mod types {
    pub mod public {
        ...
        #[postgres(name = "blogs_tags")]
        pub struct BlogsTags {
            pub id: uuid::Uuid,
            pub name: String,
        }
        #[derive(Debug)]
        pub struct BlogsTagsBorrowed<'a> {
            pub id: uuid::Uuid,
            pub name: &'a str,
        }
        impl<'a> From<BlogsTagsBorrowed<'a>> for BlogsTags {
            fn from(BlogsTagsBorrowed { id, name }: BlogsTagsBorrowed<'a>) -> Self {
                Self {
                    id,
                    name: name.into(),
                }
        ...
        impl<'a> postgres_types::FromSql<'a> for BlogsTagsBorrowed<'a> {
            fn from_sql(
                ...
                out: &'a [u8],
            ) -> Result<BlogsTagsBorrowed<'a>, Box<dyn std::error::Error + Sync + Send>>
            {
                ...
                let _oid = postgres_types::private::read_be_i32(&mut out)?;
                let name = postgres_types::private::read_value(fields[1].type_(), &mut out)?;
                Ok(BlogsTagsBorrowed { id, name })
            }
        ...
        impl<'a> postgres_types::ToSql for BlogsTagsBorrowed<'a> {
            ...
            {
                let BlogsTagsBorrowed { id, name } = self;
                let fields = match *ty.kind() {
                    postgres_types::Kind::Composite(ref fields) => fields,
                    _ => unreachable!(),
                };
                ...
                match *ty.kind() {
                    postgres_types::Kind::Composite(ref fields) => {
                        ...
                        fields.iter().all(|f| match f.name() {
                            "id" => <uuid::Uuid as postgres_types::ToSql>::accepts(f.type_()),
...
pub mod queries {
    pub mod blogs {
        ...
        pub struct PublishedBlog {
            ...
            pub tags: Vec<super::super::types::public::BlogsTags>,
        }
        pub struct PublishedBlogBorrowed<'a> {
            ...
            pub tags: cornucopia_async::ArrayIterator<
                'a,
                super::super::types::public::BlogsTagsBorrowed<'a>,
            >,
        }
...
where id = $1",
    ...
    pub mod tags {
        ...
        use futures::{StreamExt, TryStreamExt};
        #[derive(Debug)]
        pub struct InsertBlogTagsParams<T1: cornucopia_async::ArraySql<Item = uuid::Uuid>> {
            pub blog_id: uuid::Uuid,
            pub tag_ids: T1,
        }
        #[derive(Debug)]
        pub struct DeleteBlogTagsParams<T1: cornucopia_async::ArraySql<Item = uuid::Uuid>> {
            pub blog_id: uuid::Uuid,
            pub tag_ids: T1,
        }
        #[derive(Debug, Clone, PartialEq)]
        ...
        pub struct TagQuery<'a, C: GenericClient, T, const N: usize> {
            ...
            params: [&'a (dyn postgres_types::ToSql + Sync); N],
            stmt: &'a mut cornucopia_async::private::Stmt,
            extractor: fn(&tokio_postgres::Row) -> TagBorrowed,
            mapper: fn(TagBorrowed) -> T,
        }
        impl<'a, C, T: 'a, const N: usize> TagQuery<'a, C, T, N>
        where
            C: GenericClient,
        {
            pub fn map<R>(self, mapper: fn(TagBorrowed) -> R) -> TagQuery<'a, C, R, N> {
                TagQuery {
                    client: self.client,
                    params: self.params,
                    stmt: self.stmt,
        ...
        pub fn get_all_tags() -> GetAllTagsStmt {
            GetAllTagsStmt(cornucopia_async::private::Stmt::new(
                "select
	*
from
	blogs_tags",
        ...
        pub struct GetAllTagsStmt(cornucopia_async::private::Stmt);
        impl GetAllTagsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
        ...
        pub fn create_tag() -> CreateTagStmt {
            CreateTagStmt(cornucopia_async::private::Stmt::new(
                "insert into
blogs_tags(name)
values($1)
returning *",
        ...
        pub struct CreateTagStmt(cornucopia_async::private::Stmt);
        impl CreateTagStmt {
        ...
        pub fn delete_tag() -> DeleteTagStmt {
            DeleteTagStmt(cornucopia_async::private::Stmt::new(
                "delete from
blogs_tags
where id=$1
returning id",
        ...
        pub struct DeleteTagStmt(cornucopia_async::private::Stmt);
        impl DeleteTagStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
        ...
        pub fn insert_blog_tags() -> InsertBlogTagsStmt {
            InsertBlogTagsStmt(cornucopia_async::private::Stmt::new(
                "insert into blogs_blog_tags(blog_id, tag_id)
select $1, id
from blogs_tags
where id = any($2) on conflict (blog_id, tag_id) do nothing",
            ))
        }
        pub struct InsertBlogTagsStmt(cornucopia_async::private::Stmt);
        impl InsertBlogTagsStmt {
            pub async fn bind<
                'a,
                C: GenericClient,
                T1: cornucopia_async::ArraySql<Item = uuid::Uuid>,
            >(
                &'a mut self,
                client: &'a C,
                blog_id: &'a uuid::Uuid,
        ...
        impl<'a, C: GenericClient + Send + Sync, T1: cornucopia_async::ArraySql<Item = uuid::Uuid>>
            cornucopia_async::Params<
                ...
                >,
                C,
            > for InsertBlogTagsStmt
        {
            fn params(
                &'a mut self,
                client: &'a C,
                params: &'a InsertBlogTagsParams<T1>,
            ) -> std::pin::Pin<
        ...
        pub fn delete_blog_tags() -> DeleteBlogTagsStmt {
            DeleteBlogTagsStmt(cornucopia_async::private::Stmt::new(
                "delete from
blogs_blog_tags
where blog_id = $1 and tag_id != any($2)",
            ))
        }
        pub struct DeleteBlogTagsStmt(cornucopia_async::private::Stmt);
        impl DeleteBlogTagsStmt {
            pub async fn bind<
                'a,
                C: GenericClient,
                T1: cornucopia_async::ArraySql<Item = uuid::Uuid>,
        ...
        impl<'a, C: GenericClient + Send + Sync, T1: cornucopia_async::ArraySql<Item = uuid::Uuid>>
            cornucopia_async::Params<
                ...
                >,
                C,
            > for DeleteBlogTagsStmt
        {
            fn params(
                &'a mut self,
                client: &'a C,
                params: &'a DeleteBlogTagsParams<T1>,
            ) -> std::pin::Pin<
                Box<dyn futures::Future<Output = Result<u64, tokio_postgres::Error>> + Send + 'a>,
            > {
                Box::pin(self.bind(client, &params.blog_id, &params.tag_ids))
        ...
        pub fn get_blog_tags() -> GetBlogTagsStmt {
            GetBlogTagsStmt(cornucopia_async::private::Stmt::new(
                "select bt.*
...
where blog_id = $1",
        ...
        pub struct GetBlogTagsStmt(cornucopia_async::private::Stmt);
        impl GetBlogTagsStmt {
            pub fn bind<'a, C: GenericClient>(
                &'a mut self,
                client: &'a C,
                blog_id: &'a uuid::Uuid,
