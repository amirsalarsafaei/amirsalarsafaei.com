    ...
    <div className="controls-container">
      ...
      >
        ...
        <div className="camera-controls">
          <button onClick={() => onViewChange("screen")} title="View Screen">
            <FaDesktop className="screen-icon" />
          </button>
          <button onClick={() => onViewChange("gopher")} title="View Gopher">
          ...
          <button onClick={() => onViewChange("wall")} title="View Github Wall">
            <FaGithub className="github-icon" />
          </button>
          <button onClick={() => onViewChange("tux")} title="View Tux">
