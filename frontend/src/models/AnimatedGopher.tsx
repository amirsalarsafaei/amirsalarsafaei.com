...
export default function AnimatedGopherModel(props: AnimatedGopherProps) {
  ...
  useFrame((state) => {
    if (modelRef.current) {
      ...
      if (leftHand) {
        leftHand.rotation.y =
          0.09 + Math.sin(state.clock.elapsedTime * 1.5) * 1.5;
      }
      ...
      const rightPupil = modelRef.current.getObjectByName(
        "right_pupil",
      ) as Mesh;
      ...
      if (leftEye && rightEye && leftPupil && rightPupil) {
        ...
        const lookTarget = state.camera.position
          .clone()
          .add(dir.multiplyScalar(distance));

        if (isMobile) {
          lookTarget.add(new Vector3(pointer.x * 20, pointer.y * 20, 0));
        }
        ...
        const leftOffsetX = Math.max(
          -maxOffset,
          Math.min(maxOffset, lookAtLeft.x * 0.05),
        );
        const leftOffsetY = Math.max(
          -maxOffset,
          Math.min(maxOffset, lookAtLeft.y * 0.05),
        );
        ...
        const rightOffsetX = Math.max(
          -maxOffset,
          Math.min(maxOffset, lookAtRight.x * 0.05),
        );
        const rightOffsetY = Math.max(
          -maxOffset,
          Math.min(maxOffset, lookAtRight.y * 0.05),
        );
  ...
  return (
    <group ref={modelRef} {...props} dispose={null}>
      ...
      <mesh
        ...
        position={[0.213, 0.124, 1.032]}
        rotation={[-0.001, 0, -0.049]}
        scale={0.102}
      />
      <mesh
        name="left_eye"
        ...
        material={materials["Material.012"]}
        position={[-0.211, 0.885, 0.958]}
        rotation={[-0.295, -0.285, -0.224]}
        scale={0.381}
      />
      <mesh
        name="left_hand"
        ...
        position={[-1.101, -0.189, 0.574]}
        rotation={[0.002, 0.086, 0.399]}
        scale={0.176}
      />
      <mesh
        name="left_pupil"
        ...
        position={[-0.255, 0.994, 1.355]}
        rotation={[-0.296, -0.009, -0.05]}
        scale={0.109}
      />
      <mesh
        name="nose_tip001"
        geometry={nodes.nose_tip001.geometry}
        material={materials["Material.011"]}
        position={[0.27, 0.558, 1.192]}
        rotation={[-0.013, -0.006, -0.07]}
        scale={0.14}
      />
      <mesh
        name="right_eye"
        ...
        material={materials["Material.012"]}
        position={[0.746, 0.772, 0.793]}
        rotation={[-0.282, 0.265, -0.036]}
        scale={0.366}
      />
      <mesh
        name="right_hand001"
        geometry={nodes.right_hand001.geometry}
        material={materials["Material.010"]}
        position={[1.287, -0.597, 0.383]}
        rotation={[-0.204, -0.136, 2.012]}
        scale={0.165}
      />
      <mesh
        name="right_pupil"
        ...
        material={materials["Material.011"]}
        position={[0.788, 0.871, 1.176]}
        rotation={[0.015, -0.07, -0.159]}
        scale={0.109}
      />
      <mesh
        name="Object_6"
      ...
      <mesh
        ...
        material={materials["Material.010"]}
        position={[-0.69, -1.936, -0.067]}
        rotation={[0.309, -0.722, 1.881]}
        scale={0.176}
      />
      <mesh
        name="Object_30"
        ...
        material={materials["Material.010"]}
        position={[0.207, -1.988, -0.077]}
        rotation={[-0.525, -0.486, 0.575]}
        scale={0.176}
      />
      <mesh
        name="Object_32"
